        ...
        <div className="d-flex justify-content-center align-items-center">
            <div className="border col-7 rounded p-4">
                <form onSubmit={handleSubmit}>
                    <div className="m-2">
                        <h3 >Crear cuenta</h3>
                        <div>Ya tienes cuenta? iniciar sesion</div>
                    </div>
                    ...
                    <input className="rounded p-2 m-2 col-12" placeholder="Contraseña" type="password" />
                    <input className="rounded p-2 m-2 col-12" placeholder="Confirmar contraseña" type="password" />
                    <button className="rounded p-2 m-2 col-12 btn bg-success text-white" type="submit">Registrarse</button>
                </form>
            </div>
        </div>
